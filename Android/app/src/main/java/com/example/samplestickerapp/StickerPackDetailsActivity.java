...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    private StickerPackDetailsActivity instance;
...
//                Toast.makeText(instance,"btn clicked!",Toast.LENGTH_LONG).show();
                String requestUrl = "http://freelancer.azurewebsites.net/test1234/contents.json";
                StickerJsonRequest m_req = new StickerJsonRequest(requestUrl);
                m_req.getResult(instance);
            }
        });
    }
